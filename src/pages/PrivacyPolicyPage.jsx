            ...
            <section className="section-padding" style={{ backgroundColor: 'var(--white)' }}>
                <div className="container" style={{ maxWidth: '800px', margin: '0 auto', lineHeight: '1.8', color: 'var(--text-gray)' }}>
                    ...
                    <p style={{ marginBottom: '30px' }}>
                        نحن في مؤسسة السبيعي للمحاماة والاستشارات القانونية نولي اهتماماً بالغاً بخصوصية عملائنا وسرية معلوماتهم الشخصية والقانونية. تهدف هذه السياسة إلى توضيح كيفية جمع واستخدام وحماية البيانات التي تزودنا بها.
                    </p>
